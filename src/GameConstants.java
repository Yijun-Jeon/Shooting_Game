public class GameConstants {
	...
	public static final int GAMEBOARDWIDTH  = 740;
	public static final int GAMEBOARDHEIGHT = 830;
	
	public static final int ENEMY1IMGWIDTH	= 89;
	public static final int ENEMY1IMGHEIGHT = 75;
	public static final int ENEMY2IMGWIDTH 	= 89;
	public static final int ENEMY2IMGHEIGHT = 67;
	public static final int ENEMY3IMGWIDTH 	= 89;
	public static final int ENEMY3IMGHEIGHT = 65;
	...
	public static final int PLANEIMGHEIGHT = 86;
	
	public static final int PLANEBULLETSPEED 	 = 5;	
	public static final int PLANEBULLETIMGWIDTH  = 18;
	public static final int PLANEBULLETIMGHEIGHT = 61;
	
	public static final int SPECIALBULLETIMGWIDTH = 100;
	public static final int SPECIALBULLETIMGHEIGHT = 75;
